<template>
  ...
  <div v-else class="song-edit-container">
    <form>
      ...
      <div class="author-container">Author: {{ song.authorName }}</div>
      <div
    ...
    <button @click="saveSong">do not save changes -></button>
...
// TODO: modify UI to disallow editing the original text, but allows for suggesting new lines
